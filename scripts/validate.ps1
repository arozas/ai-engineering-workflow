...
foreach ($smokeToken in @('opencode2', '/api/health', '/global/health', '/agent', '/command', '/experimental/tool/ids', 'Authorization', '<redacted>', 'workflow_state', 'workflow_standard_review', 'workflow_quick_review', 'workflow_gate')) {
