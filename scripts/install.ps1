...
Write-Host 'Then run /ai-bootstrap inside OpenCode to generate .ai/bootstrap-proposal/.'
Write-Host 'Review or edit the proposal, then run /ai-bootstrap-apply to persist project context.'
