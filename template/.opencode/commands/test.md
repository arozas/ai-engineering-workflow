...
Then invoke `workflow_gate` with the approved run ID and report the generated PASS, FAIL, or NOT RUN status for every command in the frozen affected-module matrix. Never choose a smaller module set or write or repair gate evidence manually.
