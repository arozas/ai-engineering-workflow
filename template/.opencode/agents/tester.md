...
Never weaken existing assertions or rewrite a failing test merely to match an implementation. Use the configured quality gate and report exact outcomes as PASS, FAIL, or NOT RUN.
